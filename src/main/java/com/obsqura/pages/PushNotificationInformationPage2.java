...
public class PushNotificationInformationPage2 extends PageUtility{
	WebDriver driver;

	public PushNotificationInformationPage2(WebDriver driver)  {
		super(driver);
		this.driver = driver;
	...
	public String NotificationAlert2(String currentDate,String name,String depiction) {
		//String name = "Obsqura";
